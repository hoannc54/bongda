                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="user_level">
                                        ...
                                        <option value="1" <?php if (set_value('user_level') == 1) { echo "selected";}?>>Admod</option>
                                        <option value="2" <?php if (set_value('user_level') == 2) { echo "selected";}?>>Manger</option>
                                        <option value="3" <?php if (set_value('user_level') == 3) { echo "selected";}?>>Admin</option>
                                    </select>
                                </div>
                            </div><!-- /.box-body -->
